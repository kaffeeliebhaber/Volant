package de.kaffeeliebhaber.entitySystem.stats;

import de.kaffeeliebhaber.inventorySystem.EquipmentManagerListener;
...
public class PlayerStats extends CharacterStats implements EquipmentManagerListener {
	...
	@Override
	public void equipped(Item oldItem, Item newItem, ItemType itemType) {
